          ...
          <div className={`${styles.heroHeadText} flex flex-col text-white`}>
            ...
            <div className="flex items-center gap-4 mt-4 mb-2">
              <button onClick={() => {
                ...
                link.href = '/RohanResume.pdf';
                link.download = 'Rohan_Kumar_Tailor_Resume.pdf';
                link.click();
              }} className="border-2 border-cyan-300 text-cyan-300 text-[16px] leading-none px-5 py-3 hover:bg-cyan-300 hover:text-black rounded-lg font-semibold transition-all flex items-center">
                Download Resume <i className="fa-solid fa-download ml-2 text-[16px]"></i>
              </button>
            </div>
